...
const Product2 = ({ plpimaage, title, id }) => {
  ...
  return (
    <>
      <div className="bg-[#141414] lg:w-[90%] w-full   text-white  rounded-md">
        ...
        <div className="text-[13px] p-1">{id}</div>
        <div className="flex  justify-between p-1 ">
          <div className="flex text-[14px]  items-center  space-x-2 p-1">
            ...
            {/* <span>{title}</span> */}
            <del className="text-[13px] text-white">{id}</del>

            <span className="text-[12px] text-green-500">{id}% off</span>
          </div>
